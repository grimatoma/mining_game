...
//
// final inventoryCountsStateProviderOld =
...
//   for (final item in ref.watch(inventoryStateProviderOld).itemSlots) {
...
// });
//
// final inventoryStateProviderOld =
//     StateNotifierProvider<InventoryStateControllerOld, InventoryOld>((ref) {
//   return InventoryStateControllerOld(ref.watch(gameEventManagerProvider));
// });
//
// // class Inventory {
...
//
// @freezed
// class InventoryOld with _$Inventory {
//   const InventoryOld._();
//
//   const factory InventoryOld(BuiltList<ItemInstance?> itemSlots) = _Inventory;
//
//   factory InventoryOld.fromJson(Map<String, Object?> json) =>
//       _$InventoryFromJson(json);
//
//   InventoryOld rebuild(Function(ListBuilder<ItemInstance?>) updates) =>
...
// }
//
// class InventoryStateControllerOld extends StateNotifier<InventoryOld> {
//   InventoryStateControllerOld(GameEventManager gameEventManager)
//       : super(HiveManager.getData(BoxKey.INVENTORY, InventoryOld.fromJson,
//             () => InventoryOld(<ItemInstance?>[].build()))) {
